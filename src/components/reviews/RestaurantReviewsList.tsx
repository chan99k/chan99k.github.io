...
export function RestaurantReviewsList({
  reviews,
  className = '',
}: RestaurantReviewsListProps) {
  const [filteredReviews, setFilteredReviews] =
    useState<RestaurantReview[]>(reviews);
  ...
  return (
    <div className={className}>
      ...
      <div className='flex flex-col gap-4 mb-6'>
        ...
        {/* Filters */}
        <ReviewFilters reviews={reviews} onFilterChange={handleFilterChange} />
      </div>
      ...
      <div className='mb-4'>
        <p className='text-sm text-gray-600 dark:text-gray-400'>
          ...
          {searchQuery && (
            <span className='ml-1'>(&quot;{searchQuery}&quot; 검색 결과)</span>
          )}
        </p>
      </div>
