...
export function RestaurantCard({
  ...
  return (
    <div
      className={`bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300 h-full flex flex-col ${className}`}
    >
      {/* Image Gallery */}
