...
export function ProblemSolutionCardsSection({
  ...
  const filterOptions = useMemo(
    () =>
      ProblemSolutionFilterManager.getFilterOptions(
        allProblemSolutions,
        projects
      ),
  ...
  const filteredProblemSolutions = useMemo(
    () =>
      ProblemSolutionFilterManager.applyFilters(
        allProblemSolutions,
        filters,
        blogPosts
      ),
  ...
  const stats = useMemo(
    () =>
      BlogPortfolioIntegrator.generateProblemSolutionStats(
        allProblemSolutions,
        blogPosts
      ),
  ...
  return (
    <section className='mb-16'>
                ...
                <div className='flex items-center space-x-2'>
                  <input
                    ...
                    onChange={e =>
                      setFilters(prev => ({
                        ...prev,
                        showOnlyWithBlogPosts: e.target.checked,
                      }))
                    }
                    className='rounded border-border text-primary focus:ring-primary focus:ring-offset-0'
                  />
                  <label
                    htmlFor='blogPostFilter'
      ...
      <div className='mb-6 text-sm text-muted-foreground'>
        Showing {filteredProblemSolutions.length} of{' '}
        {allProblemSolutions.length} problem-solution cards
        {hasActiveFilters && (
