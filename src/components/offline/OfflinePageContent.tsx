/**
 * Offline Page Content Component
 * Client component for offline page functionality
 */
      ...
      <div className="max-w-md w-full text-center">
        ...
        <div className="text-left">
          ...
          <p className="text-gray-600 dark:text-gray-400 text-sm">
            Offline content manager temporarily disabled during navigation system implementation.
          </p>
        </div>
