...
description: "@Validated 컨트롤러가 인터페이스를 구현할 때, 구현체에만 @Valid를 선언하면 Hibernate
  Validator가 서브타입이 파라미터 제약을 추가했다고 판단하여 HV000151을 발생시킨다. 이 에러는 해당 메서드만이 아니라 클래스
  전체의 메타데이터 빌드를 실패시켜, 모든 엔드포인트가 500을 반환한다."
pubDate: 2026-02-20
tags:
  - 개발/Spring
  - 디버깅
