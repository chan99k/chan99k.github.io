...
const sampleReviews: RestaurantReview[] = [
  {
    ...
    review: '강남역 근처에 위치한 이 작은 한식당은 정말 숨은 보석 같은 곳입니다. 특히 김치찌개가 일품이에요!'
  },
  {
    ...
    review: '서초동에 위치한 고급 일식당으로, 정통 오마카세를 경험할 수 있는 곳입니다.'
  }
];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            ...
            지도에서 위치를 확인하고 네비게이션 앱으로 바로 이동할 수 있습니다.
          </p>
        </div>
        ...
        <div className="bg-blue-50 dark:bg-blue-950 rounded-lg p-6 mt-8">
          ...
          <div className="text-blue-800 dark:text-blue-200 space-y-2">
            <p>• <strong>목록/지도 전환:</strong> 상단의 버튼으로 목록 보기와 지도 보기를 전환할 수 있습니다.</p>
            <p>• <strong>지도에서 음식점 선택:</strong> 지도의 마커를 클릭하여 해당 음식점의 상세 정보를 확인할 수 있습니다.</p>
            <p>• <strong>외부 지도 앱:</strong> 네이버맵, 카카오맵, 구글맵 링크를 통해 더 자세한 정보를 확인할 수 있습니다.</p>
            <p>• <strong>내비게이션:</strong> 모바일에서는 내비게이션 앱으로 바로 연결됩니다.</p>
          </div>
        </div>
      </div>
    </div>
