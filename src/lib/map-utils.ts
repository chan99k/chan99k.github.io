 ...
 */
export function getBestMapProvider(restaurant: RestaurantReview): 'naver' | 'kakao' | 'google' {
  const { coordinates } = restaurant.location;
 ...
 */
export function generateShareableLocation(restaurant: RestaurantReview): string {
