...
export class FrontmatterValidator {
  static validateBlogFrontmatter(
  ...
  static validateRestaurantFrontmatter(
    frontmatter: Record<string, unknown>
  ): ValidationResult {
    try {
  ...
  static validatePortfolioFrontmatter(
    frontmatter: Record<string, unknown>
  ): ValidationResult {
    try {
...
export function validateFrontmatterWithLogging(
  ...
  const result = FrontmatterValidator.validateByContentType(
    contentType,
    frontmatter
  );
