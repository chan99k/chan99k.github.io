...
export function ensureMapLinks(review: RestaurantReview): RestaurantReview {
  ...
  if (!review.mapLinks || !review.mapLinks.naver || !review.mapLinks.kakao || !review.mapLinks.google) {
 ...
 */
export function processRestaurantReviews(reviews: RestaurantReview[]): RestaurantReview[] {
 ...
 */
export function validateRestaurantReview(review: Partial<RestaurantReview>): string[] {
  const errors: string[] = [];
  ...
  if (typeof review.priceRange !== 'number' || review.priceRange < 1 || review.priceRange > 5) {
 ...
 */
export function generateRestaurantId(review: Partial<RestaurantReview>): string {
